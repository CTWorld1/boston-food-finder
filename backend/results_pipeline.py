...
def build_restaurant_result(
    ...
    distance_meters = basic.get("distance")
    ...
    return {
        ...
        # Geoapify / OpenStreetMap generally
        # does not provide consumer ratings
        # or Google/Yelp-style price levels.
        "rating": "Not available",
...
def search_restaurants(
    ...
    for place in places:
        try:
            ...
            # If one restaurant detail call fails,
            # skip it instead of stopping the whole search.
            continue
